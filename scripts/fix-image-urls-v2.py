...
def fix_image_urls():
    ...
    for file_path in md_files:
        try:
            ...
            # 修正前のURLを検索（より柔軟なパターン）
            old_urls = re.findall(r'https://object-storage\.tyo2\.conoha\.io/v1/nc_2520d9a1_blog-astro-assets/blog-astro-assets/blog-images/[^"\s]+', content)
            ...
            if old_urls:
                ...
                # 修正後のURLを確認
                new_urls = re.findall(r'https://object-storage\.tyo2\.conoha\.io/v1/nc_938a9d00d6004f1390c354d4a15ef25b/blog-astro-assets/blog-images/[^"\s]+', new_content)
